...
namespace FieldNation.SDK.Api
{
    ...
    /// </summary>
    public interface IEcheckApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class EcheckApi : IEcheckApi
    {
        private FieldNation.SDK.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="EcheckApi"/> class.
        /// </summary>
        /// <returns></returns>
        public EcheckApi(String basePath)
        {
        ...
        /// <returns></returns>
        public EcheckApi(Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> UpdateFundByFundWithHttpInfo (int? companyId, int? financeId, FundTransaction fundTransaction = null)
        {
            ...
            if (companyId == null)
                throw new ApiException(400, "Missing required parameter 'companyId' when calling EcheckApi->UpdateFundByFund");
            // verify the required parameter 'financeId' is set
            if (financeId == null)
                throw new ApiException(400, "Missing required parameter 'financeId' when calling EcheckApi->UpdateFundByFund");
