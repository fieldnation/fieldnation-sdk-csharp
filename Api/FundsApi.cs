...
namespace FieldNation.SDK.Api
{
    ...
    public partial class FundsApi : IFundsApi
    {
        ...
        public ApiResponse< InlineResponse200 > GetCreditCardFeesByCompanyWithHttpInfo (int? companyId)
        {
            ...
            if (companyId == null)
                throw new ApiException(400, "Missing required parameter 'companyId' when calling FundsApi->GetCreditCardFeesByCompany");
        ...
        public ApiResponse<Object> UpdateFundByFundWithHttpInfo (int? companyId, int? financeId, FundTransaction fundTransaction = null)
        {
            // verify the required parameter 'companyId' is set
            if (companyId == null)
                throw new ApiException(400, "Missing required parameter 'companyId' when calling FundsApi->UpdateFundByFund");
            // verify the required parameter 'financeId' is set
            if (financeId == null)
                throw new ApiException(400, "Missing required parameter 'financeId' when calling FundsApi->UpdateFundByFund");
