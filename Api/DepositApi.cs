...
namespace FieldNation.SDK.Api
{
    ...
    public partial class DepositApi : IDepositApi
    {
        ...
        /// <returns></returns>
        public DepositApi(Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> UpdateFundByFundWithHttpInfo (int? companyId, int? financeId, FundTransaction fundTransaction = null)
        {
            ...
            if (companyId == null)
                throw new ApiException(400, "Missing required parameter 'companyId' when calling DepositApi->UpdateFundByFund");
            // verify the required parameter 'financeId' is set
            if (financeId == null)
                throw new ApiException(400, "Missing required parameter 'financeId' when calling DepositApi->UpdateFundByFund");
