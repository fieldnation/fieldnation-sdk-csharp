...
namespace FieldNation.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProviderRatings :  IEquatable<ProviderRatings>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProviderRatings" /> class.
        /// </summary>
        /// <param name="Ratings">Ratings.</param>
        /// <param name="Stars">Stars.</param>
        /// <param name="Categories">Categories.</param>
        public ProviderRatings(int? Ratings = default(int?), decimal? Stars = default(decimal?), List<WorkOrderRatingsServiceCompanyOverallCategories> Categories = default(List<WorkOrderRatingsServiceCompanyOverallCategories>))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProviderRatings);
        }

        /// <summary>
        /// Returns true if ProviderRatings instances are equal
        /// </summary>
        /// <param name="other">Instance of ProviderRatings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProviderRatings other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
