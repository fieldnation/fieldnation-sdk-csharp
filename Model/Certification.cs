...
namespace FieldNation.SDK.Model
{
    ...
    public partial class Certification :  IEquatable<Certification>, IValidatableObject
    {
        ...
        public Certification(int? Id = default(int?), string Name = default(string), int? TermId = default(int?), string Number = default(string))
        {
            this.Id = Id;
            this.Name = Name;
            this.TermId = TermId;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Certification);
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TermId != null)
                    hash = hash * 59 + this.TermId.GetHashCode();
                if (this.Number != null)
