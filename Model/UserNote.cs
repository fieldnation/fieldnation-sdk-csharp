...
namespace FieldNation.SDK.Model
{
    ...
    public partial class UserNote :  IEquatable<UserNote>, IValidatableObject
    {
        ...
        public UserNote(int? Id = default(int?), string Name = default(string), string Note = default(string), List<ActionsEnum> Actions = default(List<ActionsEnum>))
        {
            this.Id = Id;
            this.Name = Name;
            this.Note = Note;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UserNote);
        }

        /// <summary>
        /// Returns true if UserNote instances are equal
        /// </summary>
        /// <param name="other">Instance of UserNote to be compared</param>
        /// <returns>Boolean</returns>
