...
namespace FieldNation.SDK.Model
{
    ...
    public partial class Problems :  IEquatable<Problems>, IValidatableObject
    {
        ...
        public enum ActionsEnum
        {
            ...
            /// <summary>
            /// Enum Viewmessage for "view_message"
            /// </summary>
            [EnumMember(Value = "view_message")]
            Viewmessage
        }
        ...
        public List<Problem> Results { get; set; }
        ...
        public List<ProblemType> Types { get; set; }

        /// <summary>
        /// Gets or Sets Sum
        /// </summary>
        [DataMember(Name="sum", EmitDefaultValue=false)]
        public ProblemsSum Sum { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Problems);
        }

        /// <summary>
        /// Returns true if Problems instances are equal
        /// </summary>
        /// <param name="other">Instance of Problems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Problems other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
