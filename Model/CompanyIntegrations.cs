...
namespace FieldNation.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CompanyIntegrations :  IEquatable<CompanyIntegrations>, IValidatableObject
    {
        /// <summary>
        ...
        public ListEnvelope Envelope { get; set; }

        /// <summary>
        /// Gets or Sets Results
        /// </summary>
        [DataMember(Name="results", EmitDefaultValue=false)]
        public List<CompanyIntegration> Results { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CompanyIntegrations);
        }

        /// <summary>
        /// Returns true if CompanyIntegrations instances are equal
        /// </summary>
        /// <param name="other">Instance of CompanyIntegrations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompanyIntegrations other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
