...
namespace FieldNation.SDK.Model
{
    ...
    public partial class TaskGroup :  IEquatable<TaskGroup>, IValidatableObject
    {
        ...
        public TaskGroup(string Label = default(string), string Id = default(string))
        {
            this.Label = Label;
            this.Id = Id;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TaskGroup);
        }

        /// <summary>
        /// Returns true if TaskGroup instances are equal
        /// </summary>
        /// <param name="other">Instance of TaskGroup to be compared</param>
        /// <returns>Boolean</returns>
