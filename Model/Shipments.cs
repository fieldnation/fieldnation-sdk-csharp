...
namespace FieldNation.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Shipments :  IEquatable<Shipments>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Shipments);
        }

        /// <summary>
        /// Returns true if Shipments instances are equal
        /// </summary>
        /// <param name="other">Instance of Shipments to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Shipments other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
