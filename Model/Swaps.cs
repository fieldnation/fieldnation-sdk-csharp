...
namespace FieldNation.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Swaps :  IEquatable<Swaps>, IValidatableObject
    {
        ...
        public List<Swap> Results { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Swaps);
        }

        /// <summary>
        /// Returns true if Swaps instances are equal
        /// </summary>
        /// <param name="other">Instance of Swaps to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Swaps other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
