...
namespace FieldNation.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PayModifiers :  IEquatable<PayModifiers>, IValidatableObject
    {
        ...
        public PayModifiersSum Sum { get; set; }
        ...
        public List<PayModifier> Results { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PayModifiers);
        }

        /// <summary>
        /// Returns true if PayModifiers instances are equal
        /// </summary>
        /// <param name="other">Instance of PayModifiers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayModifiers other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
