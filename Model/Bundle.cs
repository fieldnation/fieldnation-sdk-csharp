...
namespace FieldNation.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Bundle :  IEquatable<Bundle>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Bundle);
        }

        /// <summary>
        /// Returns true if Bundle instances are equal
        /// </summary>
        /// <param name="other">Instance of Bundle to be compared</param>
        /// <returns>Boolean</returns>
