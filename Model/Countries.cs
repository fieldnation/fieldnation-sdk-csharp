...
namespace FieldNation.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Countries :  IEquatable<Countries>, IValidatableObject
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Countries);
        }

        /// <summary>
        /// Returns true if Countries instances are equal
        /// </summary>
        /// <param name="other">Instance of Countries to be compared</param>
        /// <returns>Boolean</returns>
