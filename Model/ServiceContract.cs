...
namespace FieldNation.SDK.Model
{
    ...
    public partial class ServiceContract :  IEquatable<ServiceContract>, IValidatableObject
    {
        ...
        public ServiceContract(int? Id = default(int?), string Name = default(string))
        {
            this.Id = Id;
            this.Name = Name;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ServiceContract);
        }

        /// <summary>
        /// Returns true if ServiceContract instances are equal
        /// </summary>
        /// <param name="other">Instance of ServiceContract to be compared</param>
        /// <returns>Boolean</returns>
