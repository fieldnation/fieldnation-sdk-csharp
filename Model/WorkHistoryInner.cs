...
namespace FieldNation.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WorkHistoryInner :  IEquatable<WorkHistoryInner>, IValidatableObject
    {
        ...
        public List<WorkHistoryInnerResults> Results { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as WorkHistoryInner);
        }

        /// <summary>
        /// Returns true if WorkHistoryInner instances are equal
        /// </summary>
        /// <param name="other">Instance of WorkHistoryInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkHistoryInner other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
