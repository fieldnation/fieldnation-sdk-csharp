...
namespace FieldNation.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Routes :  IEquatable<Routes>, IValidatableObject
    {
        ...
        /// <summary>
        /// Gets or Sets UserRoute
        /// </summary>
        [DataMember(Name="user_route", EmitDefaultValue=false)]
        public Route UserRoute { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  UserRoute: ").Append(UserRoute).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Routes);
        }

        /// <summary>
        /// Returns true if Routes instances are equal
        /// </summary>
        /// <param name="other">Instance of Routes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Routes other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.UserRoute == other.UserRoute ||
                    this.UserRoute != null &&
                    this.UserRoute.Equals(other.UserRoute)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.UserRoute != null)
                    hash = hash * 59 + this.UserRoute.GetHashCode();
